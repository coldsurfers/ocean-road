...
import { GridCardList, semantics } from '@coldsurf/ocean-road';
import styled from '@emotion/styled';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories#default-export
const meta = {
  title: 'extensions/GridCardMasonryItem',
  component: GridCardList.MasonryItem,
  parameters: {
  ...
  args: { onClick: fn() },
} satisfies Meta<typeof GridCardList.MasonryItem>;
...
export const MasonryItem: Story = {
  args: {
    ...
    href: '/event/coldsurf-festival-vol-1',
    id: 'uuid',
  },
};
