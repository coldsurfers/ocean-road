...
import { type ColorScheme, ColorSchemeProvider, GlobalStyle } from '@coldsurf/ocean-road';
...
import type { ColorScheme } from '@coldsurf/ocean-road';
...
```tsx
import { useColorScheme } from '@coldsurf/ocean-road'
...
```tsx
import { type ColorScheme, ColorSchemeToggle } from '@coldsurf/ocean-road'
