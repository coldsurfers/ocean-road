...
| 컴포넌트 | 설명 |
|----------|------|
| `AppHeader.FixedHeader` | 스크롤 애니메이션이 적용된 고정 헤더 |
| `AppHeader.FloatingHeader` | 스크롤 시 나타나는 플로팅 헤더 |
...
화면 상단에 고정되는 헤더입니다. 스크롤에 따른 애니메이션이 내장되어 있습니다.
...
스크롤 시 나타나는 플로팅 헤더입니다. 서비스명과 로고를 함께 표시합니다.
