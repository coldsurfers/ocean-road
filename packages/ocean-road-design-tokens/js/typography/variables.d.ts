...
// in their tsconfig.json to be able to `import {} from '@coldsurfers/ocean-road-design-tokens/js/typography/variables'`.
...
import tokens from '../../dist/js/typography/variables';
