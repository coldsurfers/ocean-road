...
// in their tsconfig.json to be able to `import {} from '@coldsurfers/ocean-road-design-tokens/js/semantic/theme-variables'`.
...
import tokens from '../../dist/js/semantic/theme-variables';
