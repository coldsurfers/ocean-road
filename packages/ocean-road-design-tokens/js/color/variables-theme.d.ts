...
// in their tsconfig.json to be able to `import {} from '@coldsurfers/ocean-road-design-tokens/js/color/variables-theme'`.
...
import tokens from '../../dist/js/color/variables-theme';
